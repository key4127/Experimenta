...
from experimenta.agent.deepwiki.prompts import RAG_SYSTEM_PROMPT as system_prompt, RAG_TEMPLATE
...
from experimenta.agent.deepwiki.config import configs
from experimenta.agent.deepwiki.data_pipeline import DatabaseManager
...
class RAG(adal.Component):
    ...
    def __init__(self, provider="deepseek", model=None, use_s3: bool = False):  # noqa: F841 - use_s3 is kept for compatibility
        ...
        Args:
            provider: Model provider to use (deepseek, openai, ollama)
        ...
        #     from experimenta.agent.deepwiki.ollama_patch import check_ollama_model_exists
...
9. For pipe characters (|) in text, write them directly without escaping them"""
        ...
        from experimenta.agent.deepwiki.config import get_model_config
